<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" class="formulario__input" id="pais" name="pais" placeholder="Pais Ponente"
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" class="formulario__input" id="tags__input" name="tags__input"
            placeholder="EJ. Node, PHP, UX, UI">
    </div>
